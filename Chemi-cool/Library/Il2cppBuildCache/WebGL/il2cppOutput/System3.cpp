			...
			if (currentDelegate->get_method_is_virtual_10())
			{
				if (il2cpp_codegen_method_is_generic_instance(targetMethod))
				{
					if (il2cpp_codegen_method_is_interface_method(targetMethod))
						...
						result = GenericVirtualFuncInvoker0< IPAddressU5BU5D_tCB5D2302BEB72DDB30825F9EF457D39EEA5001EB* >::Invoke(targetMethod, ___hostName0);
				}
				else
				{
					if (il2cpp_codegen_method_is_interface_method(targetMethod))
						...
						result = VirtualFuncInvoker0< IPAddressU5BU5D_tCB5D2302BEB72DDB30825F9EF457D39EEA5001EB* >::Invoke(il2cpp_codegen_method_get_slot(targetMethod), ___hostName0);
				}
			}
			else
			{
